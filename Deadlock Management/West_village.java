...
public class West_village extends Thread
{
		...
		private String[] village_tasks = {"Hunting for Food", "Trading with the East Village", "Scouting the Surrounding Land"};
		private String cur_task;
		private String name;
		Semaphore traveling;
		
		public West_village(String villager, int task_num, Semaphore road)
		{
			 name = villager;
			 traveling = road;
		...
		public void run()
		{
			synchronized (traveling)
			{
				...
				try 
				{
					...
					System.out.println("West Villager: " + name + " is now traveling to perform their task.");
				}
				...
				try
				{
					...
					System.out.println(name + " has finished their task and is now returning to the West Village!");
				}
				catch (InterruptedException e)
				{
					e.printStackTrace();
				...
				System.out.println(name + " returned to West Village");
			}
		}
}
